    ...
    private static List<IncidentType> GetIncidentTypes()
    {
        return new List<IncidentType>()
        {
            new()
            {
                ...
                CollectPerson = true,
                ShowCounselingOpportunities = true
            },
            ...
            new()
            {
                ...
                CollectPerson = true, ShowCounselingOpportunities = true
            },
            new()
            {
                Id = "A7A975E0-5952-434E-9D87-F8B049D84016", Name = "Crisis Call", CollectTime = true,
                RequiresTime = true,
                CollectLocation = true, CollectPerson = true, ShowCounselingOpportunities = true
            },
